...
function Dashboard() {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/api/itemppos")
      .then((response) => response.json())
      .then((data) => setPurchaseOrders(data));
  }, []);

  useEffect(() => {
    fetch("http://localhost:8000/api/itempos").then((response) =>
      response.json()
    );
  }, []);
  ...
  const handlePOChange = async (event) => {
    ...
    try {
      ...
      if (selectedPurchase) {
        ...
        console.log("Selected PO Associated ID:", associatedID);
        ...
        <div>
          <div className="table-Dashboard">
            ...
            <div className="tableCPR">
              ...
              <h2>Total Purchase Price: ₹{totalPurchasePrice.toFixed(2)}</h2>
            </div>
            <div className="tableCPR">
